...
$invoiceId = $_GET['id'];
$invoiceRs = Database::search("SELECT * FROM `invoice` WHERE `id`='".$invoiceId."'");

$invoiceData = $invoiceRs ->fetch_assoc();

$umail = $invoiceData["user_email"];

if($invoiceData["cartId"] == 1){
    $oid = $invoiceData["order_id"];
            ...
            <div class="col-12">
                ...
                ?>
                    ...
                    <div class="row mt-2 text-center">
                        <div class="col-4"> <?php echo $data1["title"] ?> </div>
                        <div class="col-4"> USD <?php echo $data1["price"] ?></div>
                        <div class="col-4"> <?php echo $data1["get_qty"] ?></div>
